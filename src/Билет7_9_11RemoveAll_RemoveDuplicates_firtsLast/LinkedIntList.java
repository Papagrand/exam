package Билет7_9_11RemoveAll_RemoveDuplicates_firtsLast;
...
public class LinkedIntList<T> {
    ...
    public static void main(String[] args) {
        LinkedIntList<Integer> list = new LinkedIntList<Integer>();//начало 9ого билета
        list.push(2);
        list.push(2);
        list.push(6);
        list.push(6);
        ...
        list.printList();//Конец 9ого билета
        System.out.println();
        LinkedIntList<Integer> l1 = new LinkedIntList<Integer>();//Начало 7ого билета
        l1.push(1);
        l1.push(3);
        l1.push(5);
        l1.push(7);
        ...
        System.out.println("Enter 1 to removeAll in 1st List, or 2 to removeAll in 2nd List");
        ...
        l1.printList();
        l2.printList();
        System.out.println();//Конец 7ого билета
        list.firstLast();//Начало и конец 11ого
        list.printList();
